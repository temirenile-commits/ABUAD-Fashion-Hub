        ...
        <>
          <aside className={styles.sidebar}>
              ...
              <div className={styles.brandInfo} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1.25rem' }}>
                ...
                <div style={{ flex: 1, overflow: 'hidden' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    ...
                    <span style={{ fontSize: '0.65rem', fontWeight: 800, color: 'var(--text-400)', letterSpacing: '0.05em' }}>MASTERCART GENERAL</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <nav className={styles.nav}>
              ...
              <button className={`${styles.navItem} ${activeTab === 'ai' ? styles.navActive : ''}`} onClick={() => setActiveTab('ai')} style={{ color: '#FFFFFF', background: activeTab === 'ai' ? '#121214' : 'transparent' }}>
      ...
      <main className={styles.main}>
        <header className={styles.dashboardHeader}>
          <div className={styles.headerTitle}>
            <h1 className={styles.title}>MasterCart Marketplace</h1>
          ...
          <div className={styles.headerActions}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 12px', background: 'var(--bg-200)', borderRadius: '20px', border: '1px solid var(--border)' }}>
              <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#121214' }} />
        ...
        {activeTab === 'overview' && (
          <div className={styles.tabContent} id="tour-vendor-overview" data-miles-tour="vendor-overview">
            ...
            <div className={styles.statsGrid}>
              <div className={`${styles.statCard} ${styles.statCardVibrant}`} id="tour-vendor-wallet" data-miles-tour="vendor-wallet">
            ...
            <div className={styles.dashboardSplit}>
              <div className={styles.splitMain} id="tour-vendor-orders-tab" data-miles-tour="vendor-orders">
              ...
              <div className={styles.splitSide}>
                <div className={styles.quickActions}>
                  <h3>Quick Actions</h3>
                  <button className={styles.actionBtn} onClick={() => setActiveTab('inventory')} id="tour-vendor-add-product" data-miles-tour="vendor-product-upload">Add New Product</button>
