        ...
        <div className={`card ${styles.card}`} style={{ textAlign: 'center', padding: '4rem 2rem' }}>
          ...
          <div style={{ background: 'var(--bg-200)', padding: '1.5rem', borderRadius: '12px', marginBottom: '2rem', border: '1px solid var(--primary)' }}>
            ...
            <a 
              ...
              style={{ width: '100%', justifyContent: 'center', background: '#1F1F23', borderColor: '#27272A' }}
            >
    ...
    <main className="container">
      <div className={styles.page}>
        <div className={styles.header}>
          <h1>Become an MasterCart Vendor</h1>
          <p>Launch your store vividly. No upfront fees — get 5 free credits to start.</p>
        </div>

        {errorMsg && (
          <div style={{ padding: '1rem', background: '#18181B', color: '#FFFFFF', borderRadius: '8px', marginBottom: '1.5rem', textAlign: 'center' }}>
            {errorMsg}
          </div>
        )}
          ...
          {step === 5 && (
            <div className={styles.stepContent}>
              ...
              <div style={{ height: '300px', overflowY: 'auto', padding: '1.25rem', background: 'var(--bg-200)', borderRadius: '8px', fontSize: '0.85rem', marginBottom: '1.5rem', border: '1px solid var(--border)', lineHeight: '1.6' }}>
                ...
                <p style={{ marginBottom: '1rem', color: 'var(--text-300)' }}>All vendors must undergo manual identity verification. Submitting false academic (Matriculation/Room number) or business credentials will lead to an immediate and permanent ban from the MasterCart platform.</p>
