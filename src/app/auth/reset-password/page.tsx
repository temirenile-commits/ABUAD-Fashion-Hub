  ...
  return (
    <div className={styles.page}>
      <div className={`card ${styles.card}`}>
        ...
        {errorMsg && (
          <div style={{ padding: '0.75rem', background: 'rgba(0,0,0,0.1)', color: '#000000', borderRadius: '8px', marginBottom: '1.5rem', fontSize: '0.85rem', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
            <AlertCircle size={16} />
            {errorMsg}
          </div>
        )}
