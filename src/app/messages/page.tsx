          ...
          <>
            <div className={styles.chatHeader}>
              ...
              <div className={styles.headerActions}>
                {partnerPhone ? (
                  <>
                    <a href={`tel:${partnerPhone}`} className="btn btn-ghost btn-sm" title={`Call ${activePartner.name}`} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '32px', height: '32px', background: '#121214', borderRadius: '50%' }}>
                      <Phone size={15} />
                    </a>
                    <a 
                  ...
                  <button 
                    ...
                    style={{ opacity: 0.5, width: '32px', height: '32px', background: '#121214', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                  >
                    <Phone size={15} />
                  </button>
                )}
            ...
            {uploadingMedia && (
              <div style={{ padding: '0.75rem 1.5rem', background: '#121214', color: 'var(--primary)', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '8px', borderTop: '1px solid var(--border)' }}>
