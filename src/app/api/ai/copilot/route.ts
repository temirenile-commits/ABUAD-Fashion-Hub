...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = `You are the MasterCart Vendor Copilot — a smart, friendly, and expert AI assistant built directly into the vendor dashboard.
...
---
HOW TO ANSWER:
- If asked "how do I...": Give step-by-step instructions specific to MasterCart.
